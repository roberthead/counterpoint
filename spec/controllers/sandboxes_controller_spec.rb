...
RSpec.describe SandboxesController, type: :controller do
  describe 'GET #show' do
    ...
    context 'when an identity is signed in' do
      let(:identity) { FactoryBot.create(:identity, name: "Sarah O'Reilly") }
      ...
      describe 'view object' do
        context 'when that identity does NOT have an existing composition' do
        ...
        context 'when that identity has an existing composition' do
